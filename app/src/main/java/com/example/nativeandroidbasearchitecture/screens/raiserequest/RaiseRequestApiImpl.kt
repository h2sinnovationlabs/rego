    ...
    override suspend fun getFormOptions(): RaiseRequestFormOptions = RaiseRequestFormOptions(
        ...
        partTypes = listOf(
            PartType(
                "alloy_wheels",
                "Alloy wheels",
                com.example.nativeandroidbasearchitecture.R.drawable.alloy_wheel
            ),
            PartType(
                "headlamps",
                "Headlamps",
                com.example.nativeandroidbasearchitecture.R.drawable.car_light
            ),
            PartType(
                "plastic_repair",
                "Plastic repair",
                com.example.nativeandroidbasearchitecture.R.drawable.car_seat
            )
        )
    )
